...
tk.Label(a1,text="Biochar properties",font=("Microsoft Yahei",13),bg="#E2EAF4",fg="black").place(x=45,y=150)
...
tk.Label(a1,text="Element composition of biochar",font=("Microsoft Yahei",13),bg="#E2EAF4",fg="black").place(x=45,y=230)
